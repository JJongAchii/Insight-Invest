...
TABLE_BENCHMARK_NAV = "portfolio.benchmark_nav"
TABLE_BENCHMARK_METRICS = "portfolio.benchmark_metrics"
...
# Arrow 스키마 (벤치마크 NAV)
BENCHMARK_NAV_SCHEMA = pa.schema(
    [
        pa.field("port_id", pa.int32(), nullable=False),
        pa.field("trade_date", pa.date32(), nullable=False),
        pa.field("value", pa.float64(), nullable=False),
...
# Arrow 스키마 (벤치마크 성과 지표)
BENCHMARK_METRICS_SCHEMA = pa.schema(
    [
        pa.field("port_id", pa.int32(), nullable=False),
        pa.field("ann_ret", pa.float64(), nullable=True),
        pa.field("ann_vol", pa.float64(), nullable=True),
